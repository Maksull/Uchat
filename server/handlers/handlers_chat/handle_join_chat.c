...
int check_user_membership(int user_id, int chat_id, t_server_utils *utils)
{
...
int check_max_chat_limit(int user_id, t_server_utils *utils)
{
...
int insert_user_as_member(const cJSON *chat_name, t_server_utils *utils)
{

...
void build_rightbar_chat()
{
    ...
    if (utils->current_chat->permissions == ADMIN_MEMBER)
    {
        ...
        GtkWidget *delete_chat_label = gtk_label_new("Delete");
        ...
        GtkWidget *change_chat_name_label = gtk_label_new("Change name");
    ...
    else
    {
        ...
        GtkWidget *leave_chat_label = gtk_label_new("Leave");

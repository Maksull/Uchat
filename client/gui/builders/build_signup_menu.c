...
void build_signup_menu()
{
    ...
    GtkWidget *signup_menu_title = create_signup_menu_title();
    ...
    GtkWidget *username_field = create_username_field();

    GtkWidget *username_notify_label = create_username_notify_label();
    ...
    GtkWidget *password_field = create_password_field();

    GtkWidget *password_notify_label = create_password_notify_label();
    ...
    GtkWidget *repassword_field = create_repassword_field();

    GtkWidget *repassword_notify_label = create_repassword_notify_label();
    ...
    GtkWidget *signup_btn = create_signup_btn();

    GtkWidget *signup_notify_label = create_signup_notify_label();
    ...
    GtkWidget *event_switch_to_login = create_event_switch_to_login();

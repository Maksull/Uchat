...
// Function definition to create and configure the title label for changing the login window
static GtkWidget *create_and_configure_login_title()
{
    ...
    return change_login_title;
}

// Function definition to create and configure the label and entry field for the new login
static void create_and_configure_login_widgets(GtkWidget **login_label, GtkWidget **login_field)
{
    *login_label = gtk_label_new("New login:");
...
// Function definition to create and configure the notification label for the login field
static GtkWidget *create_and_configure_login_notify_label()
{
    ...
    return login_notify_label;
}

// Function definition to create a horizontal box container for buttons
...
static GtkWidget *create_and_configure_submit_button()
{
...
static GtkWidget *create_and_configure_cancel_button()
{
...
static void pack_buttons_into_box(GtkWidget *btn_box, GtkWidget *change_login_btn, GtkWidget *cancel_btn)
{
...
static void pack_elements_into_main_container(GtkWidget *change_login_box, GtkWidget *change_login_title, GtkWidget *login_label, GtkWidget *login_field, GtkWidget *login_notify_label, GtkWidget *btn_box)
{
...
void build_change_login_window(GtkWidget *widget, gpointer data)
{
    ...
    GtkWidget *change_login_title = create_and_configure_login_title();

    // Create and configure the label and entry field for the new login
    GtkWidget *login_label, *login_field;
    create_and_configure_login_widgets(&login_label, &login_field);

    // Create and configure the notification label for the login field
    GtkWidget *login_notify_label = create_and_configure_login_notify_label();

    // Create a horizontal box container for buttons
    GtkWidget *btn_box = create_button_box();

    // Create and configure the Submit button
    GtkWidget *change_login_btn = create_and_configure_submit_button();

    // Create and configure the Cancel button
    GtkWidget *cancel_btn = create_and_configure_cancel_button();

    // Pack buttons into the button box container
    pack_buttons_into_box(btn_box, change_login_btn, cancel_btn);

    // Pack all elements into the main container
    pack_elements_into_main_container(change_login_box, change_login_title, login_label, login_field, login_notify_label, btn_box);

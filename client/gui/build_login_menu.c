...
void build_login_menu()
{
    ...
    // Create a title box for login menu
    ...
    // Create a box for username input
    ...
    // Create a box for password input
    ...
    // Create an event box for signup option
    ...
    gtk_box_pack_start(GTK_BOX(text_box), event_switch_to_signup, FALSE, FALSE, 0); // Pack event box into text box

    // Pack all components into the login menu
    gtk_box_pack_start(GTK_BOX(login_menu), title_box, FALSE, FALSE, 0); // Pack title box into login menu
    gtk_box_pack_start(GTK_BOX(login_menu), username_box, FALSE, FALSE, 0); // Pack username box into login menu
    gtk_box_pack_start(GTK_BOX(login_menu), password_box, FALSE, FALSE, 0); // Pack password box into login menu
    gtk_box_pack_start(GTK_BOX(login_menu), login_btn_box, FALSE, FALSE, 0); // Pack login button box into login menu
    gtk_box_pack_start(GTK_BOX(login_menu), text_box, FALSE, FALSE, 0); // Pack text box into login menu
